...
<head>
    ...
    <title>Devenez Volontaire avec Sterna Africa : Engagez-vous pour un Impact Réel</title>

    <meta name="robots" content="index">
    <meta name="robots" content="follow">

    <meta name="description" content="Participez à une mission solidaire enrichissante avec Sterna Africa. Engagez-vous comme volontaire, contribuez à des projets impactants et vivez une expérience interculturelle authentique. Rejoignez-nous dès aujourd’hui.">

    <meta property="og:title" content="Devenez Volontaire avec Sterna Africa : Engagez-vous pour un Impact Réel" />

    <meta property="og:description" content="Participez à une mission solidaire enrichissante avec Sterna Africa. Engagez-vous comme volontaire, contribuez à des projets impactants et vivez une expérience interculturelle authentique. Rejoignez-nous dès aujourd’hui." />
    <!-- Favicons -->
    ...
    <!-- all css -->
    <link rel="canonical" href="https://sternaafrica.org/recrutement/">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <h3 class="mb-3">Abonnez-vous à nos réseaux avant tout</h3>

                <div class="d-flex align-items-center gap-2">
                    <!-- Linkdin -->
                    <a href="https://www.linkedin.com/feed/?trk=seo-authwall-base_google-one-tap-submit" class="d-flex align-items-center justify-content-center rounded-circle" style="width:45px;height:45px;">
                        <img src="https://static.vecteezy.com/system/resources/previews/018/930/480/non_2x/linkedin-logo-linkedin-icon-transparent-free-png.png" alt="LinkedIn" style="width:70px;height:70px;">
                    </a>

                    <!-- Instagram -->
                    <a href="https://www.instagram.com/associationsterna/" class="d-flex align-items-center justify-content-center rounded-circle" style="width:45px;height:45px;">
                        <img src="https://cdn.pixabay.com/photo/2021/06/15/12/14/instagram-6338393_1280.png" alt="Instagram" style="width:45px;height:45px;" class="rounded-circle">
                    </a>

                    <!-- Tiktok -->
                    <a href="https://www.tiktok.com/@association.stern?_t=ZM-8y15x6ZkcPW&_r=1" class="d-flex align-items-center justify-content-center rounded-circle" style="width:45px;height:45px;">
                        <img src="https://www.numerama.com/wp-content/uploads/2018/11/tik-tok.jpg" alt="TikTok" style="width:45px;height:45px;" class="rounded-circle">
                    </a>

                    <!-- Twiter -->
                    <a href="https://twitter.com/AfricaSterna?t=LQyImKIWRq9a9zfv2PlFew&s=09" class="d-flex align-items-center justify-content-center rounded-circle" style="width:45px;height:45px;">
                        <img src="https://play-lh.googleusercontent.com/XyI6Hyz9AFg7E_joVzX2zh6CpWm9B2DG2JuEz5meCFVm4-wTKTnHgqbmg62iFKe4Gzca" alt="X" style="width:45px;height:45px;" class="rounded-circle">
                    </a>

                    <!-- WhatsApp -->
                    <a href="https://whatsapp.com/channel/0029VaYKD2K4CrfbdEL6uY3e" class="d-flex align-items-center justify-content-center rounded-circle" style="width:45px;height:45px;">
                        <img src="https://png.pngtree.com/element_our/md/20180506/md_5aeee501bc171.jpg" alt="WhatsApp" style="width:45px;height:45px;" class="rounded-circle">
                    </a>

                    <!-- youTube -->
                    <a href="https://www.youtube.com/channel/UCekpxdwSoamybXcXT2rtJww" class="d-flex align-items-center justify-content-center rounded-circle" style="width:45px;height:45px;">
                        <img src="https://yt3.googleusercontent.com/3s6evpqAiDU9tQR4sC2siJippbH2RWVPnwHgyl4V0th2iuQz0VDQZbUhQBGmsxLYo-mjG6TqZQ=s900-c-k-c0x00ffffff-no-rj" alt="YouTube" style="width:45px;height:45px;" class="rounded-circle">
                    </a>
                </div>
                <hr>
                ...
                <form action="./traitement_form.php" method="post" enctype="multipart/form-data" class="shadow p-2 mb-3 rounded">
                    ...
                    <div class="mt-3">
                        ...
                        <small class="text-warning">Formats : JPG, JPEG, PNG — Taille max : 2 Mo.</small>

                        <div id="preview-container" class="mt-2 hidden">
                            <img id="image-preview" src="#" alt="Aperçu" class="rounded border border-slate-700" style="max-width: 150px; height: auto;">
                            <p class="text-xs text-slate-400 mt-1">Aperçu de votre photo</p>
                        </div>
                    </div>
                    ...
                    <script>
                        document.getElementById('imageUpload').onchange = function(evt) {
                            ...
                            if (file) {
                                // Vérification de la taille côté client (Optionnel mais recommandé)
                                if (file.size > 2 * 1024 * 1024) {
                                    alert("Ce fichier est trop lourd (max 2 Mo)");
                                    this.value = ""; // On vide l'input
                    ...
                    <div class="">
                        ...
                        <input
                            ...
                            name="numero"
                            class="form-control"
                            placeholder="WhatsApp num (+225 XXXXXXXXX)"
                            pattern="^\+?[0-9]{1,15}$"
                            maxlength="16"
                            required>
                    </div>
                    ...
                    <div class="mb-2">
                        ...
                        <textarea class="form-control" rows="5" placeholder="parler nous unpeu de vous, de votre parcours. Et, dite nous sur combien de nos canaux êtes-vous abonné actuellement ?" name="dernierMot" required></textarea>
                    </div>
                    ...
                    <p class="text-danger">
                        <strong>
                            NB : N’oubliez pas de vous abonner à nos différents canaux sociaux, une étape indispensable dans le processus de recrutement.
                        </strong>
                    </p>
                    ...
                    <img src="https://i.postimg.cc/4yyMK3ry/IMG-20251114-WA0002.jpg" alt="benevol" class="w-100 rounded">
                </form>
            </div>
            <div class="col-md-3"></div>
        </div>
