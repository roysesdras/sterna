...
<body>
    ...
    <div class="container-fluid mt-4">
        ...
        <div class="d-flex justify-content-between mb-5 flex-wrap gap-2">
            <a href="https://sternaafrica.org/old/admin/admin_dashboard.php" class="btn btn-secondary btn-sm">← Retour Dashboard</a>
            <a href="../rapport/admin_rapports.php" class="btn btn-primary btn-sm"><i class="bi bi-file-earmark-pdf"></i> Gestion Bulletins / Rapports</a>
