...
?>
    ...
    <body class="bg-gray-100 text-gray-800 antialiased selection:bg-[#ea750fff]/30">
        <main class="max-w-5xl mx-auto px-4 pt-05 pb-12">
            <?php // require_once('../config/nav.php'); 
            ?>
            <div class="flex flex-col lg:flex-row gap-12 max-w-6xl mx-auto">

                <aside class="lg:w-16 order-2 lg:order-1">
                    <div class="lg:sticky lg:top-32 flex lg:flex-col justify-center gap-4 bg-white p-4 rounded-3xl shadow-sm">
            ...
            <div class="container-fluid autre_contenu mt-20">
                <?php include_once $_SERVER['DOCUMENT_ROOT'] . '/config/autres_actualites.php';
                ?>
            </div>
