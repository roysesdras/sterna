...
<body>
    <div class="container-fluid">
        ...
        <div class="mb-3 comic-neue-regular">
            ...
            <div class="mb-4">
                ...
                <a href="../actualite/admin_actualites.php" class="btn btn-outline-info btn-sm comic-neue-regular">Gérer les actualités</a> ou
                <a href="../rapport/admin_rapports.php" class="btn btn-outline-primary btn-sm comic-neue-regular">Gérer les rapports</a> ou encore
                ...
                <a href="admin_pont_solidaire.php" class="btn btn-primary btn-sm comic-neue-regular shadow-sm">Gérer les Récits (Pont Solidaire)</a>
                <a href="../evenement/edit_temoignage.php" class="btn btn-outline-secondary btn-sm comic-neue-regular ms-2">Corriger les témoignages</a>
            </div>
            ...
            <a href="../evenement/admin_add_mission.php" class="btn btn-success btn-sm comic-neue-regular">Ajout nouvelle activité</a> ou
            <a href="../actualite/admin_actualites.php" class="btn btn-outline-info btn-sm comic-neue-regular">Gérer les actualités</a> ou
            <a href="../projets/admin_projets.php" class="btn btn-outline-primary btn-sm comic-neue-regular">Gérer les projets</a> ou
            <a href="../rapport/admin_rapports.php" class="btn btn-outline-light btn-sm comic-neue-regular">Gérer les rapports</a> ou encore
            <a class="btn btn-outline-warning me-5 btn-sm comic-neue-regular" data-bs-toggle="modal" data-bs-target="#exampleModal">Ajouter une antenne</a>

            <a href="admin_pont_solidaire.php" class="btn btn-primary btn-sm comic-neue-regular shadow-sm mb-2">Gérer les Récits (Pont Solidaire)</a><br>
    ...
    <footer class="bg-gray-800 text-white py-8 text-center">
        <p>&copy; 2026 Sterna Africa. Tous droits réservés.</p>
    </footer>
