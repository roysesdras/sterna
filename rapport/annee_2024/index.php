...
<body>
    ...
    .rapport-container {
        ...
        margin-bottom: 100px; /* Espace pour ne pas cacher le bas du PDF par le bouton */
    }
    ...
    .download-fab {
        ...
        z-index: 1050; /* Passe au-dessus de tout */
        display: flex;
        align-items: center;
        gap: 10px;
    ...
    .download-fab:hover {
        background: #305196; /* Ton bleu au survol */
...
<div class="container my-5">
    <div class="text-center mb-4">
        <h2 class="comic-neue-bold" style="color: #305196;">Rapport Annuel 2024</h2>
...
<a href="RAPPORT ANNUEL 2024.pdf" class="download-fab comic-neue-bold" download>
