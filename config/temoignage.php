    ...
    <div class="max-w-7xl mx-auto px-6 flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div class="relative mt-8 md:mt-0">
            <h2 class="text-2xl md:text-4xl font-black text-white uppercase tracking-tighter">
                Ce qu'ils <span class="text-sterna-blue">disent</span>
            </h2>
            <img src="/assets/img/external/baf0f05e37_mascotte2.png" alt="Mascotte" class="hidden md:block absolute -top-5 -right-24 w-20 h-20 object-contain drop-shadow-md animate-[bounce_5s_infinite]">
        </div>
