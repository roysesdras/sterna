<section class="py-10overflow-hidden mt-8 md:mt-20" id="about">
    <div class="max-w-7xl mx-auto px-4">
        ...
        <div class="mb-4">
            <h2 class="text-4xl font-black text-sterna-blue uppercase tracking-tighter border-l-8 border-sterna-yellow pl-6">
                Qui Sommes<span class="text-sterna-yellow"> nous ?</span>
            </h2>
            <div class="w-20 h-1.5 bg-urunani-orange rounded-full"></div>
        </div>

        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
            
            <div class="lg:col-span-5 bg-gray-50 rounded-[40px] p-4 relative overflow-hidden flex flex-col justify-center group bg-sterna-yellow">
                <i class="fi fi-rr-quote-right absolute -top-4 -right-4 text-9xl text-sterna-blue/70 rotate-12 transition-transform group-hover:rotate-0 duration-700"></i>
                
                <p class="text-xl text-gray-50 leading-relaxed font-medium relative z-10">
                    Association d’Éducation à la Citoyenneté et à la Solidarité Internationale (ECSI), Créée en 2019 et active au <b class="text-urunani-blue">Bénin</b>, <b class="text-urunani-blue">Côte d’Ivoire</b>, <b class="text-urunani-blue">Burkina Faso</b>, <b class="text-urunani-blue">Togo</b> et <b class="text-urunani-blue">France</b>,
            ...
            <div class="lg:col-span-7 hidden md:grid grid-cols-1 md:grid-cols-2 gap-6 order-block">
                ...
                <a href="/old/pages/femmes.php">
                    <div class="p-4 rounded-[35px] border border-gray-100 hover:shadow-2xl hover:shadow-orange-100 transition-all duration-500 group bg-sterna-blue">
                        ...
                        <h3 class="text-xl font-black text-gray-50 uppercase mb-3">Les Femmes</h3>
                        <p class="text-gray-100 text-sm leading-relaxed font-medium">Autonomie socio-économique et défense des droits.</p>
                    </div>
                </a>
