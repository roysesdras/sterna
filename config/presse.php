<section class="relative py-20 overflow-hidden" id="presse">
    <!-- SVG de séparation en haut de la section -->
    <div class="absolute top-0 left-0 w-full overflow-hidden leading-none">
        <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none" class="relative block w-full h-12 md:h-20 text-sterna-blue fill-current">
    ...
    <div class="max-w-7xl mx-auto px-6">
        ...
        <div class="flex items-end justify-between mb-12">
            <div>
                <h2 class="text-3xl font-bold text-sterna-blue uppercase tracking-tighter border-l-8 border-sterna-blue pl-6">Dans <br><span class="text-sterna-yellow">la Presse</span></h2>
                
            </div>
            <p class="hidden md:block text-gray-700 text-xs font-bold uppercase tracking-widest">Faites défiler pour en savoir plus —></p>
        </div>

        <div class="relative group/carousel">
            <!-- Bouton Précédent -->
            <button onclick="document.getElementById('carousel-presse').scrollBy({left: -350, behavior: 'smooth'})" class="absolute left-0 top-1/2 -translate-y-1/2 z-10 w-12 h-12 bg-white/90 backdrop-blur rounded-full shadow-xl flex items-center justify-center text-sterna-blue hover:bg-sterna-yellow transition-all opacity-100 md:opacity-0 group-hover/carousel:opacity-100 -ml-4">
                <i class="fi fi-rr-angle-left text-xl mt-1 pr-1"></i>
            </button>

            <div id="carousel-presse" class="flex flex-nowrap gap-6 overflow-x-auto pb-10 scroll-smooth snap-x snap-mandatory scrollbar-hide" style="scrollbar-width: none; -ms-overflow-style: none;">
                <style>
            ...
            <div class="snap-start flex-none w-[300px] md:w-[350px] group">
                <a href="https://france-volontaires.org/actualite/temoignage/dominique-et-patrice-retraites-et-engages-dans-un-chantier-de-solidarite-internationale/" target="_blank" class="block bg-white rounded-3xl overflow-hidden shadow-lg hover:shadow-xl hover:-translate-y-2 transition-all duration-300">
                    ...
                    <div class="p-6">
                        <h4 class="font-bold text-gray-950 leading-snug mb-4">Une aventure humaine et solidaire en Côte d'Ivoire...</h4>
                        <div class="flex items-center text-[10px] font-black text-urunani-blue uppercase tracking-wider">
                            Lire l'article <i class="fi fi-rr-arrow-right ml-2 mt-0.5"></i>
                        </div>
                    </div>
                </a>
            </div>
            ...
            <div class="snap-start flex-none w-[300px] md:w-[350px] group">
                <a href="https://france-volontaires.org/actualite/temoignage/samantha-benevole-dans-une-association-defendant-les-droits-des-enfants-en-cote-divoire/" target="_blank" class="block bg-white rounded-3xl overflow-hidden shadow-lg hover:shadow-xl hover:-translate-y-2 transition-all duration-300">
                    ...
                    <div class="p-6">
                        <h4 class="font-bold text-gray-950 leading-snug mb-4">Le parcours inspirant de Samantha, bénévole engagée...</h4>
                        <div class="flex items-center text-[10px] font-black text-urunani-blue uppercase tracking-wider">
                            Lire l'article <i class="fi fi-rr-arrow-right ml-2 mt-0.5"></i>
                        </div>
                    </div>
            ...
            <div class="snap-start flex-none w-[300px] md:w-[350px] group">
                <a href="https://www.gralon.net/mairies-france/rhone/association-sterna-africa-villeurbanne_W691109313.htm" target="_blank" class="block bg-white rounded-3xl overflow-hidden shadow-lg hover:shadow-xl hover:-translate-y-2 transition-all duration-300">
                    ...
                    <div class="p-6">
                        <h4 class="font-bold text-gray-950 leading-snug mb-4">Sterna Africa : Solidarité internationale à Villeurbanne.</h4>
                        <div class="flex items-center text-[10px] font-black text-urunani-blue uppercase tracking-wider">
                            Fiche Annuaire <i class="fi fi-rr-arrow-right ml-2 mt-0.5"></i>
                        </div>
                    </div>
                </a>
            </div>
            ...
            <div class="snap-start flex-none w-[300px] md:w-[350px] group">
                <a href="https://www.radsi.org/rencontres-sterna-africa-2025" target="_blank" class="block bg-white rounded-3xl overflow-hidden shadow-lg hover:shadow-xl hover:-translate-y-2 transition-all duration-300">
                    ...
                    <div class="p-6">
                        <h4 class="font-bold text-gray-950 leading-snug mb-4">Février 2025 à Bordeaux : Madrick et le réseau Festisol.</h4>
                        <div class="flex items-center text-[10px] font-black text-urunani-blue uppercase tracking-wider">
                            Actualité <i class="fi fi-rr-arrow-right ml-2 mt-0.5"></i>
                        </div>
                    </div>
                </a>
            </div>
            ...
            <div class="snap-start flex-none w-[300px] md:w-[350px] group">
                <a href="https://www.festivaldessolidarites.org/acteurs/association-sterna-africa-14830/" target="_blank" class="block bg-white rounded-3xl overflow-hidden shadow-lg hover:shadow-xl hover:-translate-y-2 transition-all duration-300">
                    ...
                    <div class="p-6">
                        <h4 class="font-bold text-gray-950 leading-snug mb-4">Pour un monde plus juste et solidaire avec Sterna Africa.</h4>
                        <div class="flex items-center text-[10px] font-black text-urunani-blue uppercase tracking-wider">
                            Portrait Acteur <i class="fi fi-rr-arrow-right ml-2 mt-0.5"></i>
                        </div>
                    </div>
                </a>
            </div>
            ...
            <!-- Bouton Suivant -->
            <button onclick="document.getElementById('carousel-presse').scrollBy({left: 350, behavior: 'smooth'})" class="absolute right-0 top-1/2 -translate-y-1/2 z-10 w-12 h-12 bg-white/90 backdrop-blur rounded-full shadow-xl flex items-center justify-center text-sterna-blue hover:bg-sterna-yellow transition-all opacity-100 md:opacity-0 group-hover/carousel:opacity-100 -mr-4">
