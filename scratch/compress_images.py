...
TARGET_DIRS = [
    '/var/www/sternaafrica.org/uploads',
    '/var/www/sternaafrica.org/images',
    '/var/www/sternaafrica.org/assets'
]

MAX_DIM = 1200
QUALITY = 82
MIN_SIZE_BYTES = 200 * 1024  # Compress files larger than 200KB
...
print(f"\nCompression complete! Processed {processed} files. Total saved: {total_saved / (1024*1024):.2f} MB. Errors: {errors}")
