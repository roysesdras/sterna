...
TARGET_DIR = '/var/www/reseauurunaniafrique.org/assets'
MAX_DIM = 1200
QUALITY = 82
...
print("Starting Urunani image compression...")
...
print(f"\nUrunani compression complete! Processed {processed} files. Total saved: {total_saved / (1024*1024):.2f} MB. Errors: {errors}")
