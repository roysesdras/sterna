...
<body>
    ...
    <div class="bg-primary-subtle">
        <h1 class="text-center p-1 comic-neue-bold">Rapport Annuel 2023</h1>
    </div>
        ...
        <div class="row pt-2">
            ...
            <div class="col-md-2">
                <div class="position-sticky" style="top: 2rem">
                    <div class="mt-2">
                        <a href="RAPPORT ANNUEL 2023.pdf" class="get-started comic-neue-regular" download="rapporAnnuel2022">Télécharger</a>
                    </div>
                </div>
